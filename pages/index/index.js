...
Page({
  ...
  onCOM1Change:function(e){ //COM1选择
    const that =this
    if(this.data.End1_COM1_Chose){that.setData( { End1_COM1_Chose:false, MQTT_target:"NULL"}) }
    else{ that.setData({End1_COM1_Chose:true,End1_COM2_Chose:false,
      End1_COM3_Chose:false,End2_COM1_Chose:false,End2_COM2_Chose:false,End2_COM3_Chose:false,
      MQTT_target:"COM1"})}
  ...
  onCOM2Change(event){//COM2选择
    const that =this
    if(this.data.End1_COM2_Chose){that.setData( { End1_COM2_Chose:false,MQTT_target:"NULL" }) }
    else{ that.setData({End1_COM2_Chose:true,End1_COM1_Chose:false,
      End1_COM3_Chose:false,End2_COM1_Chose:false,End2_COM2_Chose:false,End2_COM3_Chose:false,
      MQTT_target:"COM2"})}
      console.log('已选择'+this.data.MQTT_target+'端口');
    that.setData({
  ...
  onCOM3Change(event){//COM3选择
      ...
      if(this.data.End1_COM3_Chose){that.setData( { End1_COM3_Chose:false,MQTT_target:"NULL" }) }
      else{ that.setData({End1_COM3_Chose:true,End1_COM1_Chose:false,
        End1_COM2_Chose:false,End2_COM1_Chose:false,End2_COM2_Chose:false,End2_COM3_Chose:false,
        MQTT_target:"COM3"})}
        console.log('已选择'+this.data.MQTT_target+'端口');
      that.setData({
        COM_Chose:3,
  ...
  onCOM4Change(event){//COM4选择
      const that =this
      if(this.data.End2_COM1_Chose){that.setData( { End2_COM1_Chose:false, MQTT_target:"NULL"}) }
      else{ that.setData({End2_COM1_Chose:true,
        End2_COM3_Chose:false,End2_COM2_Chose:false,MQTT_target:"COM4",
        End1_COM1_Chose:false,End1_COM2_Chose:false,End1_COM3_Chose:false})}
        console.log('已选择'+this.data.MQTT_target+'端口');
      that.setData({
        COM_Chose:4,
        End_Chose:'B'
  ...
  onCOM5Change(event){//COM5选择
    const that =this
    if(this.data.End2_COM2_Chose){that.setData( { End2_COM2_Chose:false, MQTT_target:"NULL"}) }
    else{ that.setData({End2_COM2_Chose:true,End2_COM1_Chose:false,
      End2_COM3_Chose:false,End1_COM1_Chose:false,End1_COM2_Chose:false,End1_COM3_Chose:false,
      MQTT_target:"COM5"})}
      console.log('已选择'+this.data.MQTT_target+'端口');
    that.setData({
      COM_Chose:5,
...
onCOM6Change(event){//COM选择
  const that =this
  if(this.data.End2_COM3_Chose){that.setData( { End2_COM3_Chose:false, MQTT_target:"NULL"}) }
  else{ that.setData({End2_COM3_Chose:true,End2_COM1_Chose:false,
    End2_COM2_Chose:false,End1_COM1_Chose:false,End1_COM2_Chose:false,End1_COM3_Chose:false,
    MQTT_target:"COM6"})}
  console.log('已选择'+this.data.MQTT_target+'端口');
  that.setData({
    COM_Chose:6,
     ...
     //   if(app.globalData.Usermone<=that.data.Timer){//调试用
      ...
      function (err) {
          ...
          if(that.data.COM_Chose==1){
              ...
              that.setData({End1_COM1_Chose:false})
          }
              ...
              that.setData({End1_COM2_Chose:false})
          }
              ...
              app.globalData.electricity= "--";
              app.globalData.electric_power= "--";
              that.setData({End1_COM3_Chose:false})
          }
              ...
              that.setData({End2_COM1_Chose:false})
          }
            ...
            app.globalData.electricity= "--";
            app.globalData.electric_power= "--";
            that.setData({End2_COM2_Chose:false})
        }
          ...
          app.globalData.electricity= "--";
          app.globalData.electric_power= "--";
          that.setData({End2_COM3_Chose:false})
      }
          if(that.data.Timer1_Chose){
            that.setData({Timer1_Chose:false})
          }
          else if(that.data.Timer2_Chose){
            that.setData({Timer2_Chose:false})
          }
          else if(that.data.Timerx_Chose){
            that.setData({Timerx_Chose:false})
          }
